...
import CatgoryData from '../CategoryList/CategoryData.json'
        ...
        >
            ...
            { isExpanded && ( <SearchContent>
                ...
                {!isLoading && !isEmpty && <React.Fragment>
                        {
                            CatgoryData.filter((value) =>{
                                if(searchTerm === "" ){
                                    return value
                                } else if(value.name.toLocaleLowerCase().includes(searchTerm.toLocaleLowerCase())){
                                    return value
                                }
                                else{
                                    return null
